...
case 'user-disabled':
return const TExceptions ('This user has been disabled. Please contact support for help.'); case 'user-not-found':
...
return const TExceptions ('An invalid argument was provided to an Authentication method.'); case 'invalid-password':
return const TExceptions ('Incorrect password, please try again.');
case 'invalid-phone-number':
return const TExceptions ('The provided Phone Number is invalid.'); case 'operation-not-allowed':
